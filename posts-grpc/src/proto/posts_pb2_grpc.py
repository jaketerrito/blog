...
from proto import posts_pb2 as proto_dot_posts__pb2
...
class PostsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPosts = channel.unary_unary(
                '/posts.v1.Posts/GetPosts',
                request_serializer=proto_dot_posts__pb2.GetPostsRequest.SerializeToString,
                response_deserializer=proto_dot_posts__pb2.GetPostsResponse.FromString,
                _registered_method=True)
...
def add_PostsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetPosts': grpc.unary_unary_rpc_method_handler(
                    servicer.GetPosts,
                    request_deserializer=proto_dot_posts__pb2.GetPostsRequest.FromString,
                    response_serializer=proto_dot_posts__pb2.GetPostsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'posts.v1.Posts', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('posts.v1.Posts', rpc_method_handlers)
...
class Posts(object):
    ...
    def GetPosts(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/posts.v1.Posts/GetPosts',
            proto_dot_posts__pb2.GetPostsRequest.SerializeToString,
            proto_dot_posts__pb2.GetPostsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
